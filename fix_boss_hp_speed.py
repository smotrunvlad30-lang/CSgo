...
# 1. Update SetupBoss to not use 99999999 HP (which causes engine glitches)
...
# 2. Update OnPlayerRunCmd to reduce speed
...
# 3. Update OnTakeDamage to perfectly block engine damage and handle HP manually without killing the bot prematurely
